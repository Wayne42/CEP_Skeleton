...
function updateTimeCursorTicks(data) {
	var div = document.getElementById("current_time_ticks");
	div.innerHTML = data;
}

function updateTimeCursorSeconds(data) {
	var div = document.getElementById("current_time_seconds");
	div.innerHTML = data;
}

function handleTimeCursor() {
	setTimeCursor(document.getElementById("set_time_to_ticks").value);
}

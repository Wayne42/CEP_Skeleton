...
$._PPP_ = {
	getVersionInfo: function () {
		return 'PPro ' + app.version + 'x' + app.build + " is pretty good";
	},
	...
	keepPanelLoaded: function () {
		app.setExtensionPersistent("de.cep.skeleton", 0); // 0, while testing (to enable rapid reload); 1 for "Never unload me, even when not visible."
	},
